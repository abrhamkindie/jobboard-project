...
//       setError(null);
//     } catch (error) {
//       const errorMsg = error.response?.data?.error || 'Failed to load interviews.';
//       setError(errorMsg);
...
//         console.log('Received interviewResponse:', data);
//         setInterviews((prev) => {
...
//       }
//     };
//   }, [fetchInterviews,authToken]); // Removed socket from dependencies
...
//                     <img
//                   src={interview.Profile || "https://via.placeholder.com/48"}
